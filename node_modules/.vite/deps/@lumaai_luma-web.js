...
${I}`;
  ...
  _compile(A, g) {
    ...
    if (!C)
      throw console.error(I.getShaderInfoLog(B)), console.log(g), new Error(`Error compiling ${A == I.VERTEX_SHADER ? "vertex" : "fragment"} shader: ${I.getShaderInfoLog(B)}`);
    return B;
  }
  _link(A, g) {
...
var G = class {
  ...
  dispatchWithExistingEvent(A, g = 1 / 0) {
    ...
    for (let B = 0; B < this.listeners.length; B++)
      if (!(this.listeners[B].priority > g) && (this.listeners[B].listener(I), typeof I == "object" && I.propagationStopped))
        return;
  }
  hasListeners() {
...
var O = class {
  constructor(A, g) {
    ...
    g.loadingAnimationEnabled != null && (this.loadingAnimation.enabled = g.loadingAnimationEnabled), g.particleRevealEnabled != null && (this.loadingAnimation.particleRevealEnabled = g.particleRevealEnabled), this.worker = new K(), this.worker.onmessage = this.onWorkerMessage.bind(this), this.workerBusy = true, this.workerReady = new Promise((I) => {
      ...
      if (I)
        for (let B of I)
          this.queueUpdateSkyboxTexture(B);
    }), A.allReady.then(() => {
      this.partialUpdate();
...
var T = class {
  ...
  async getArtifacts() {
    ...
    if (A != null)
      return (await fetch(`${uA}/${A}/public`, this.fetchOptions)).json().then((g) => {
  ...
  downloadMeta(A) {
    return this.fetchFile(A).then((g) => {
      ...
      if (this.metaVersion = I.version, this.metaVersion == 1)
        this.totalSplats = I.num_splats, this.totalBytes = I.total_bytes, this.sceneCenter = I.scene_center ?? this.sceneCenter, this.radiusList = new Float32Array(I.rlist), this.radiusStep = I.rstep ?? this.radiusStep, this.minRadius = I.minr ?? this.minRadius, this.antialias = I.antialias ?? this.antialias, this.haveSH = I.have_sh ?? this.haveSH;
      else {
...
`), additionalUniforms: { ...(_i = B == null ? void 0 : B.fragmentShaderHooks) == null ? void 0 : _i.additionalUniforms }, getFragmentColor: `
  ...
  if (t == null ? void 0 : t.additionalUniforms)
    for (let h in t.additionalUniforms)
      E[h] = t == null ? void 0 : t.additionalUniforms[h][1];
  if (o == null ? void 0 : o.additionalUniforms)
    for (let h in o.additionalUniforms)
      E[h] = o == null ? void 0 : o.additionalUniforms[h][1];
