(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('three'), require('three/examples/jsm/loaders/STLLoader.js'), require('three/examples/jsm/loaders/ColladaLoader.js'), require('three/examples/jsm/loaders/GLTFLoader.js')) :
    typeof define === 'function' && define.amd ? define(['three', 'three/examples/jsm/loaders/STLLoader.js', 'three/examples/jsm/loaders/ColladaLoader.js', 'three/examples/jsm/loaders/GLTFLoader.js'], factory) :
...
}(this, (function (THREE, STLLoader_js, ColladaLoader_js, GLTFLoader_js) { 'use strict';
    ...
    */
    ...
    class URDFLoader {
        ...
        constructor(manager) {
            ...
            this.parseVisual = true;        // NOTE create collision ?  
        ...
        defaultMeshLoader(path, manager, done) {
            ...
            } else if (/\.glb$/i.test(path)) {                  // add .glb file

                const loader = new GLTFLoader_js.GLTFLoader(manager);
                loader.load(path, glb => done(glb.scene));
